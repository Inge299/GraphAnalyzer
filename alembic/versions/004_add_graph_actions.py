# alembic/versions/004_add_graph_actions.py
"""add graph actions table

Revision ID: 004_add_graph_actions
Revises: 003_add_artifacts_tables
...
revision = '004_add_graph_actions'
down_revision = '003_add_artifacts_tables'
branch_labels = None
depends_on = None
