...
import type { ProjectCellTowerGeocodingJob, ProjectDataImportJob, ProjectDataImportPlugin, ProjectDataLoadResponse } from '../../../types/api';
...
interface ProjectDataSectionProps {
  ...
  cellTowerEnrichmentJob: ProjectCellTowerGeocodingJob | null;
  cellTowerEnrichmentLoading: boolean;
...
const ProjectDataSection: React.FC<ProjectDataSectionProps> = ({
  ...
  projectDataSelectedFiles, projectDataSelectedSummary, availableImportPlugins, projectDataLastLoadResult, projectDataImportJob, cellTowerEnrichmentJob, cellTowerEnrichmentLoading,
  projectStats, formatBytes, onLoadProjectDataFiles, onRefreshStats, onUpload, onClearSelection, onClearData, onEnrichCellTowers, onRemoveFile,
  onChangeFilePlugin,
}) => {
  ...
  return <div className="service-card">
    ...
    {cellTowerEnrichmentJob && <div className={`service-preview-summary ${cellTowerEnrichmentJob.status === 'failed' ? 'error' : 'ready'}`}><div><strong>{'\u041e\u0431\u043e\u0433\u0430\u0449\u0435\u043d\u0438\u0435 \u0411\u0421 \u043f\u043e \u0430\u0434\u0440\u0435\u0441\u0430\u043c'}</strong><span>{cellTowerEnrichmentJob.error || cellTowerEnrichmentJob.message}</span></div><div className="service-preview-summary-stats"><span>{cellTowerEnrichmentJob.progress}%</span>{cellTowerEnrichmentJob.result && <span>{`\u0417\u0430\u043f\u0438\u0441\u0435\u0439: ${cellTowerEnrichmentJob.result.written || 0}; \u043a\u043e\u043d\u0444\u043b\u0438\u043a\u0442\u043e\u0432: ${cellTowerEnrichmentJob.result.conflicting_cells || 0}`}</span>}</div></div>}
